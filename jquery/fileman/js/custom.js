...
function FileSelected(file){
   ...
   */
   ...
   // alert (fieldId);
  // $(fieldId).attr('value', file.fullPath);
  //console.log(file.fullPath);
  //$('#txtSelectedFile').val(file.fullPath);
  //$(window.parent.document).find('#txtSelectedFile').attr('value', file.fullPath);
  $('#txtSelectedFile', window.parent.document).val(file.fullPath);
